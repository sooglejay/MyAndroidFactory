...
/**
 * 历史报价-点击item-具体的报价页面-tab2
 */
public class HistoryPriceDetailFragmentTab2 extends BaseFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_history_price_detail_tab2, container, false);
    }
    ...
    private void setUp(View view, Bundle savedInstanceState) {
        context = HistoryPriceDetailFragmentTab2.this.getActivity();
