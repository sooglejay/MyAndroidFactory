...
public class RoundImageView extends ImageView {
    ...
    public RoundImageView(Context context, AttributeSet attrs, int defStyle) {
        ...
        mBorderWidth = a.getDimensionPixelSize(R.styleable.roundedimageview_border_color, DEFAULT_BORDER_WIDTH);
    ...
    private void init() {
//        mBorderColor = getResources().getColor(R.color.very_light_gray_color);
//        mBorderWidth = (int) UIUtils.dp2px(getContext(), 1);
