...
public class ModifyCompanyAddressActivity extends BaseActivity {
    ...
    private void setUpListeners() {
        titleBar.setOnTitleBarClickListener(new TitleBar.OnTitleBarClickListener() {
            ...
            public void onRightButtonClick(View v) {
                ...
                UserRetrofitUtil.modifySelfInfo(activity, userid, -1, -1,"-1", "-1", newStr,"-1", "-1", null, new NetCallback<NetWorkResultBean<Userstable>>(activity) {
                    @Override
                    ...
                    public void success(NetWorkResultBean<Userstable> userstableNetWorkResultBean, Response response) {
                        ...
                        intent.putExtra("company_address", newStr);
    ...
    private void setUpViews() {
        titleBar.initTitleBarInfo("修改公司地址", R.drawable.arrow_left, -1, "", "完成");
    ...
    private void findViews() {
        ...
        editText.setText(companyAddress);
        editText.setSelection(companyAddress.length());
    }
    ...
    private class RefreshUiHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (what) {
                case REFRESH: {
                    //输入框获取焦点
                    UIUtils.showSoftInput(ModifyCompanyAddressActivity.this, editText);
