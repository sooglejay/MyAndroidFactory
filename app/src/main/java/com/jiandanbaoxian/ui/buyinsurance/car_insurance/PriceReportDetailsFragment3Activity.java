 ...
 * 我的保险-车险-tab3
 */
public class PriceReportDetailsFragment3Activity extends BaseFragment {
    ...
    private void getFourServiceInfo() {
        UserRetrofitUtil.getInsuranceCompanyInfo(this.getActivity(), new NetCallback<NetWorkResultBean<Object>>(this.getActivity()) {
            @Override
