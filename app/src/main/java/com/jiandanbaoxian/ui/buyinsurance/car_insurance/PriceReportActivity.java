...
public class PriceReportActivity extends BaseActivity {
    ...
    public static void startActivity(Activity activity, CommPriceData data,String idcard_number,String city_no,long compulsorystartdate,long commercestartdate) {
    ...
    public void setUpListener() {
        ...
        layoutHuaanInsuranceAgent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                PriceReportDetailsActivity.startActivity(activity, commPriceData,idcard_number,city_no,compulsorystartdate,commercestartdate);
            }
        });
    }
