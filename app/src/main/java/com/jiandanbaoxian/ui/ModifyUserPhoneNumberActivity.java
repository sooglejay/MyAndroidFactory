 ...
 */
public class ModifyUserPhoneNumberActivity extends BaseActivity {
    ...
    private void setUpListeners() {
        titleBar.setOnTitleBarClickListener(new TitleBar.OnTitleBarClickListener() {
            ...
            public void onRightButtonClick(View v) {
                ...
                UserRetrofitUtil.modifySelfInfo(activity, userid, -1, -1, "-1", "-1", "-1", "-1", "-1", null, new NetCallback<NetWorkResultBean<Object>>(activity) {
                    @Override
    ...
    private void setUpViews() {
        titleBar.initTitleBarInfo("修改手机号码", R.drawable.arrow_left, -1, "", "完成");
    ...
    private class RefreshUiHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (what) {
                case REFRESH: {
                    //手机号码输入框获取焦点
                    UIUtils.showSoftInput(ModifyUserPhoneNumberActivity.this, editText);
